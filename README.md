...
## Overview
This is a basic full-stack application for a book list which will include the ability to search the Google Books API, add books to a database, and then render those books from a PostgreSQL database. You will also add the ability to update the details of a book or remove it from the collection.
...
Libraries used: Express, postgres, 
Resources used: 
- [reset css :](https://cssreset.com/scripts/eric-meyer-reset-css/)
- API for books provided by [Google](https://developers.google.com/books/docs/overview)
...
-->I worked mainly with Brandon Gibbs and Robert Carter.  I also worked some with Paul Depew.  I received assistance from Chance Harmon.
------------------------------------------------------------
## Lab 11
------------------------------------------------------------
